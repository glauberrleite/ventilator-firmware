...
void loop() {
  ...
  if (cnt > 50) {
    ...
    //Serial.print("\t\t");  
    // When working with 10V supply, the sensor gives 1 V for 0 L/min and 5 V for 200 L/min
    //Serial.print(map(ads_Voltage_ch0, 1.0, 5.0, 0.0, 200.0));
    // When working with 5V supply, the sensor gives 2.5 V for 0 cm3 H2O and 5 V for 5 cm3 H2O
    Serial.print("\t\t");
    Serial.print(ads_Voltage_ch1);
    //Serial.print("\t\t");
    //Serial.print(map(ads_Voltage_ch1, 2.5, 5.0, 0.0, 5.0));
    Serial.print("\t\t");
    Serial.print(ads_Voltage_ch2);
    //Serial.print("\t\t");
    //Serial.print(map(ads_Voltage_ch2, 2.5, 5.0, 0.0, 5.0));
    Serial.print("\t\t");
    Serial.print(ads_Voltage_ch3);
    //Serial.print("\t\t");
    //Serial.print(map(ads_Voltage_ch3, 2.5, 5.0, 0.0, 5.0));
    Serial.print("\t\t");
    Serial.print(ads_Voltage_ch4);
    //Serial.print("\t\t");
    //Serial.print(map(ads_Voltage_ch4, 2.5, 5.0, 0.0, 5.0));
